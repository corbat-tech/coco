...
Esta ampliación está **en curso en E07**: transporte y SDK se verifican por incrementos documentados; Gemini SDK se actualizó a2.22.0. El catálogo de modelos se conserva. E08 y E13 siguen pendientes; las comprobaciones de transporte no acreditan compatibilidad completa de cada modelo ni resultados de inferencia real.
...
| E07.l1–l5b | Solicitudes MCP, OAuth, SSE, stdio y lifecycle completados | Último gate MCP:343 tests; proceso stdio real verificado. No se acredita terminación de descendientes. |
