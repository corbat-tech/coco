...
| E05 / IN_PROGRESS | Permisos MCP y autoridad delegada. Depende E03–E04. | Tools remotas desconocidas no se consideran lecturas seguras; modo plan no muta. Hijo recibe concesión acotada del padre, nunca `confirmed=true` universal; rol docs coherente y resultados estructurados, sin `[object Object]`. |
