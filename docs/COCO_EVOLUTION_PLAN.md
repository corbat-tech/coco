...
Paso activo: **E07.n2a**, confirmación terminal de tools OpenAI. E07.n1 DONE para argumentos estrictos sin reparación/retry indebido,988 tests y revisión independiente correctos. E07.l5b DONE para propiedad lifecycle/HTTP y salud comprobada,343 tests y revisión independiente correctos. E07.l5a DONE para cierre stdio,19 tests incluido proceso real y revisión independiente correctos. E07.l4 DONE para propiedad SSE y reconexiones; gate95 tests y revisión independiente correctos. E07.m3 DONE para graph/workflow cancelable y resultados parciales; gate178 tests correcto. E07.m2 DONE para ejecutor alternativo delegado; gate82 tests correcto. E07.m1 DONE para manager delegado y estados tardíos; gate269 tests correcto. E07.l3 DONE para OAuth MCP cancelable y recuperación acotada a initialize401; gate amplio7634 tests yREPL27 correcto. E07.l2 DONE para señales de transporte, cancelación MCP y eliminación de replay POST; gate283 tests correcto. E07.l1 DONE para espera local MCP y limpieza de solicitudes, gate248 tests correcto. E07.k3 DONE para cancelación y renovación compartida del provider Copilot; 71 tests del gate final correctos y revisión independiente favorable. E07.k2 DONE para primitivas auth Copilot, identidad de fallback y almacenamiento privado compartido. E07.k1 DONE para deadline OAuth, conservación de credenciales y persistencia atómica; gate amplio7482 tests yREPL27 correctos. E07.j DONE para cuatro rutas de transporte Codex, lector SSE compartido y cancelación HTTP. E07.i DONE para Vertex/ADC y limpieza reader; compatibilidad launcher Windows corregida tras revisión. E07.h2 DONE para cancelación Gemini, plazo total, limpieza y propietario de retries; gate amplio 7330 tests y REPL27 correctos. E07.h1 DONE para actualización aislada SDK Gemini 2.22.0 y regresiones HTTP. E07.g DONE para transporte Anthropic y cancelación SDK HTTP local. E07.f DONE para propiedad de reintentos en adaptadores revisados. E07.e DONE para cancelación y coherencia de wrappers fallback/resiliencia. E07.d DONE para transporte OpenAI y SDK HTTP local; otros proveedores pendientes. E07.c DONE para cancelación de esperas de reintento. E07.b DONE para shell directo y estados de salida; E07.a DONE para propiedad y finalización del registro ([evidencia](evolution/E07_CANCELLATION.md)), tras el gate amplio de E06.g. E06.a–f están terminados para las contenciones descritas; E06 permanece IN_PROGRESS y COCO-06 abierto hasta completar disponibilidad/aplicabilidad de mediciones como primer incremento de E09 ([evidencia](evolution/E06_CONTAINMENT.md)). E05 DONE ([evidencia](evolution/E05_AUTHORITY.md)); E04 DONE para su alcance, con undo de archivos contenido hasta E10 ([evidencia](evolution/E04_PATHS.md)); E03 DONE ([evidencia](evolution/E03_RUNTIME.md)). E02 infraestructura npm local DONE; ejecución remota pendiente y VSIX bloqueado hasta E11 ([registro](evolution/E02_RELEASE.md)). E01 baseline hermético completado; evaluación con modelo real pendiente y obligatoria para E13/E15 ([resultados](evolution/E01_BASELINE.md)). Los bloqueos abiertos impiden publicar una release estable.
