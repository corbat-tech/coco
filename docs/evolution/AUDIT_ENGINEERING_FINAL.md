...
Queda una precisión editorial recomendable: la tabla resume completitud como «All requirements implemented» y corrección como «logic correct». Las mediciones actuales no sostienen esas garantías. Sustituir por «heurística estructural de completitud» y «resultados de pruebas/compilación disponibles». Explicitar que el mínimo de seguridad actual es 100 y que siguen bloqueando los hallazgos críticos. El texto posterior ya limita las heurísticas, pero la tabla debe ser igual de precisa.
